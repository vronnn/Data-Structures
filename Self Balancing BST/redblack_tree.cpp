...
{  
    int init_value,i=0;  
    cout << "\nEnter the key value for the new node you want to insert into the Red-Black Tree : ";
    cin >> init_value; 
...
{  
    ...
    int x;  
    cout << "\nEnter the key of the node you want to remove from the Red-Black Tree : "; 
    cin >> x;  
...
{  
    ...
    int x;  
    cout << "\nEnter the key value of the node you want to find in the Red-Black Tree : "; 
    cin >> x;  
...
{  
    ...
    do  
    {  
        cout<<"\nThe list of command option for the Red-Black Tree:" ;  
        cout<<"\n1. To insert a new node in the Red-Black Tree";  
        cout<<"\n2. To search a node in the Red-Black Tree";  
        cout<<"\n3. To delete an existing node in the Red-Black Tree";  
        cout<<"\n4. To display all the node in the Red-Black Tree";  
        ...
        {  
            case 1 : obj.insert_a_node_to_rbt();  
                    cout<<"A new node has been inserted!";  
                    break;  
            case 2 :   
                    obj.search_rbt_node();  
                    break;  
